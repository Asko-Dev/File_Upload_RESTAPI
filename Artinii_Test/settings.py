"""
Django settings for Artinii_Test project.
...
SECRET_KEY = '#q&xmkt1+rr3l_2*a5slolj-kma9^x2*-d=k2ap_u$l6=z$n62'
...
ROOT_URLCONF = 'Artinii_Test.urls'
...
WSGI_APPLICATION = 'Artinii_Test.wsgi.application'
